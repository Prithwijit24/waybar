...
A sleek, ultra-compact (25px) Waybar configuration designed for **Hyprland** with a Deep Dark Blue palette, neon glow & ambient bloom, soft-amber center clock, value-reactive color indicators, custom GTK3 App Drawer, and instant hardware polling.
...
- **✨ Neon Glow & Ambient Bloom (`style.css`):**
  ...
  - Center clock uses muted **Soft Amber** (`rgba(255,184,77,0.14)` / `#e8c99a` / `0 0 10px rgba(255,184,77,0.20)`) for pleasant, non-harsh highlight.
...
| 🧡 | **Soft Amber** | `#ffb84d` / `#e8c99a` | Clock pill (`#clock`) — `rgba(255,184,77,0.14)` bg, `rgba(255,184,77,0.28)` border, `0 0 10px rgba(255,184,77,0.20)` glow |
...
- **Clock highlight (Soft Amber)**: `#clock { background-color: rgba(255,184,77,0.14); color: #e8c99a; border: 1px solid rgba(255,184,77,0.28); box-shadow: 0 0 10px rgba(255,184,77,0.20); text-shadow: 0 0 8px rgba(255,184,77,0.42); }` — was solid `#5b9dff`; increase `0.14 → 0.20` for brighter pill.
